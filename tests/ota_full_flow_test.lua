return function(update, storage, base)
    local root = storage.join_path(base, "loom-os-runtime")
    ...
    local release = { schema=1, product="loom-os", board="esp-mosaico", channel="stable",
        version="0.1.1", release_id="loom-os:esp-mosaico:0.1.1", min_bootstrap="0.1.0",
